    ...
    <footer className="bg-gray-900 text-white py-10 pl-8">
      <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <p>
            Your trusted partner in finding the perfect home. From cozy apartments to spacious family houses, we help you discover a place that fits your lifestyle, budget, and dreams. 
          </p>
