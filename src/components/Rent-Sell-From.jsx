...
export default function RentSellFrom() {
            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex flex-col  shadow-lg rounded-lg overflow-hidden">
                    <div className=" p-6  rounded-sm">
                        <h2 className="text-3xl text-center font-bold mb-6 text-gray-600 underline underline-offset-8 decoration-[#BFA249] decoration-2">Submit Your Property for Sale or Rent</h2>
                        <p className=" text-center  mb-6 text-gray-400">Please provide the necessary details below to sell or rent your property.</p>
                        {submitted && (
