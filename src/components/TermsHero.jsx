        ...
        <div className="text-white text-center mt-20 flex flex-col md:flex-row z-10 mb-6">
          ...
          <div className="bg-[#5f7ba3]  p-3 opacity-85">
            <h2 className="text-md mt-2 font-bold">
                ...
                <span className='hover:text-[#7e6a30]'>Terms </span>
           </h2>
          </div>
        </div>
      </section>
